...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field nodes on 'UserProfile'
        db.create_table('accounts_userprofile_nodes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['accounts.userprofile'], null=False)),
            ('node', models.ForeignKey(orm['muparse.node'], null=False))
        ))
        db.create_unique('accounts_userprofile_nodes', ['userprofile_id', 'node_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field nodes on 'UserProfile'
        db.delete_table('accounts_userprofile_nodes')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'nodes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['muparse.Node']", 'null': 'True', 'blank': 'True'}),
