...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SavedSearch', fields ['default']
        db.delete_unique('muparse_savedsearch', ['default'])


    def backwards(self, orm):
        # Adding unique constraint on 'SavedSearch', fields ['default']
        db.create_unique('muparse_savedsearch', ['default'])
