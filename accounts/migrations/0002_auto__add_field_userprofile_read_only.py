...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.read_only'
        db.add_column('accounts_userprofile', 'read_only',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.read_only'
        db.delete_column('accounts_userprofile', 'read_only')
