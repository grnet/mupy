...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('muparse_savedsearch', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MuninNodes.munin_version'
        db.delete_column('muparse_muninnodes', 'munin_version')


    def backwards(self, orm):
        # Deleting field 'SavedSearch.user'
        db.delete_column('muparse_savedsearch', 'user_id')


        # User chose to not deal with backwards NULL issues for 'MuninNodes.munin_version'
        raise RuntimeError("Cannot reverse this migration. 'MuninNodes.munin_version' and its values cannot be restored.")
